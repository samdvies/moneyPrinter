...
CREATE TABLE market_data_archive (
    ...
    PRIMARY KEY (venue, market_id, "timestamp")
);

-- TimescaleDB hypertable partitioned on timestamp. Chunk interval starts at
...
-- timestamp. DESC matches hypertable chunk-pruning heuristics.
CREATE INDEX idx_market_data_archive_replay
    ON market_data_archive (venue, market_id, "timestamp" DESC);
