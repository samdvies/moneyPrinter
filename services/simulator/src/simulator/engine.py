...
# Placeholder run_id until the strategy registry (Phase 3b) supplies it.
# Integration tests inject a real run_id via fixture.
_DEFAULT_RUN_ID = "00000000-0000-0000-0000-000000000000"
...
async def _consume_order_signals(
    ...
    while not stop.is_set():
        async for signal in bus.consume(Topic.ORDER_SIGNALS, OrderSignal, block_ms=1000):
            ...
            record_alert = await record_order(signal, result.order_id, run_id, db)
